package fr.gaellalire.vestige_app.demo3.mod4;
...
public class Mod4 implements Plugin {

    @Override
    public void doSomething() {
        System.out.println("doSomething from Mod4");

        Display.setAppName("Hello");
        Display display = new Display();
        Shell shell = new Shell(display);
        shell.setLayout(new FillLayout(SWT.VERTICAL));
        shell.setText("Hello Windows World");
